# 🧠 Python for Everybody: Chapter 2 Quiz Summary
**Student:** Abdelaziz Merzoug  
**Course:** Python for Everybody

---

### 🔢 Section 1: Values, Types & Constants

**Q1: Identifying Constants**
* **Question:** In the code `print(98.6)`, what is "98.6"?
* **Answer:** **A constant*.
* **Logic:** Fixed values like numbers or strings that do not change are called constant.
...
* **Answer:** `98.
* **Logic:** The `int()` function converts a float to an integer by truncating the decimal par.

---

### 🏷️ Section 2: Variables & Reserved Words

**Q4: Variable Definition**
* **Question:** In the code `x = 42`, what is "x"?
* **Answer:** **A variable*.
* **Logic:** A variable is a named location in memory where data is stored and retrieve.
...
**Q9: The Assignment Process**
* **Question:** What does the statement `x = x + 2` do?
* **Answer:** Retrieve the current value for `x`, add two to it, and put the sum back into `x.

**Q10: Order of Evaluation**
* **Question:** Which element in a mathematical expression is evaluated first?
* **Answer:** **Parentheses ( )*.
* **Logic:** Python follows PEMDAS rules where parentheses are always respected firs.
...
### 💬 Section 4: Documentation & Interaction

**Q2: Python Comments**
* **Question:** Which of the following is a comment in Python?
* **Answer:** `# This is a test.
* **Logic:** Anything following the `#` symbol is ignored by the Python interprete.
